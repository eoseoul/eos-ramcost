...
#include <eosio.system.ramcost/native.hpp>
#include <eosiolib/asset.hpp>
#include <eosiolib/time.hpp>
#include <eosiolib/privileged.hpp>
#include <eosiolib/singleton.hpp>
#include <eosio.system.ramcost/exchange_state.hpp>
...
namespace eosiosystem {
   ...
   class system_contract : public native {
      ...
      public:
         ...
         /**
          *  Mitigate EOS balance of Bancor for BIOS new accounts RAM
          */
         void biosramcost( account_name boot, asset tokens );
