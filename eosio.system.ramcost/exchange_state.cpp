...
namespace eosiosystem {
   ...
   void exchange_state::bios_account_cost_mitigate_quote( asset in ) {
      eosio_assert( in.amount > 0, "must update a positive amount of bytes of quote" );
      eosio_assert( in.symbol == quote.balance.symbol, "unexpected asset symbol input" );
