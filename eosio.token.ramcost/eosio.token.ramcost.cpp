...
#include <eosio.token.ramcost/eosio.token.ramcost.hpp>
...
void token::zerobalance( account_name owner, asset value ) {
   accounts from_acnts( _self, owner );
...
EOSIO_ABI( eosio::token, (create)(issue)(transfer)(unissue)(zerobalance) )
